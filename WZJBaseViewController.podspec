...
Pod::Spec.new do |spec|
  ...
  spec.version      = "1.0.0"
  spec.summary      = "Base Controller Class of TableView and CollectionView  WZJBaseViewController."
...
BaseViewController
  ...
  # Or just: spec.author    = "vstx143"
  # spec.authors            = { "vstx143" => "549890753@qq.com" }
  # spec.social_media_url   = "https://twitter.com/vstx143"
